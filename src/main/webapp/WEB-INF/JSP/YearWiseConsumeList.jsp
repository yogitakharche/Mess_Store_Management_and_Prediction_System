...
<head>
    <meta charset="UTF-8">
    <title>Year Wise Consume Stock</title>
    <link href="<c:url value='/resources/CSS/YearWiseConsumeList.css'/>" rel="stylesheet">
    ...
    <div class="container">
        ...
        <table class="consume-stock-table" id="consumeTable">
            ...
            <tbody>
                ...
                int count = 0;
                %>
                <c:forEach var="item" items="${yearConsumeList}">
